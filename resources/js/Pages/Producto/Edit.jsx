...
export default function EditProducto({auth,producto,categorias,flash}){
    ...
    const { data, setData, post, processing, errors } = useForm({
        ...
        imagen: producto.imagenProducto != null?producto.imagenProducto:null,
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            setData({ ...data, imagen: file }); // Mantenemos el uso de setData para actualizar la imagen
        } else {
            setPreviewImage(null);
            setData({ ...data, imagen: null }); // Mantenemos el uso de setData para eliminar la imagen al limpiar la vista previa
        }
    };
    ...
    useEffect(() => {
        if(producto.imagenProducto != null){
            setPreviewImage(`/img_producto/${producto.imagenProducto}`)
        }
    }, [])
    //////IMAGEN///////7
    const submit = (e) => {
        e.preventDefault();
        post(route('producto.update', { id: producto.id }));
    };
